...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .photo-box { flex: 1; min-width: 280px; max-width: 400px; background: white; border-radius: 8px; padding: 1rem; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1); text-align: center; }
        .photo-box h3 { margin-bottom: 1rem; color: #555; }
        .photo-placeholder { width: 100%; aspect-ratio: 3/4; background-color: #f8f9fa; display: flex; align-items: center; justify-content: center; margin-bottom: 1rem; overflow: hidden; border-radius: 4px; border: 1px solid #eee; }
...
<body>
    <div class="container">
        ...
        <div class="size-info">
            <strong>📐 标准证件照尺寸：3:4比例 (如：300×400像素)</strong>
        </div>
...
def generate_image():
    try:
        ...
        request_data = {
            ...
            "size": data.get('size', '768x1024'),  # 3:4比例
